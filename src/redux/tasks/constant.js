...
export const GET_TASKS_WITH_DELETED_PENDING = 'GET_TASKS_WITH_DELETED_PENDING';
export const GET_TASKS_WITH_DELETED_SUCCESS = 'GET_TASKS_WITH_DELETED_SUCCESS';
export const GET_TASKS_WITH_DELETED_ERROR = 'GET_TASKS_WITH_DELETED_ERROR';
